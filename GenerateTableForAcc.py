...
ncs = FormatData(GetData(os.path.join(accDataDir, cordics[0] + "_sin.txt")))
...
ncs = FormatData(GetData(os.path.join(accDataDir, cordics[1] + "_sin.txt")))
ncc = FormatData(GetData(os.path.join(accDataDir, cordics[1] + "_cos.txt")))
nca = FormatData(GetData(os.path.join(accDataDir, vectors[1] + "_atan.txt")))

qcs = FormatData(GetData(os.path.join(accDataDir, cordics[2] + "_sin.txt")))
qcc = FormatData(GetData(os.path.join(accDataDir, cordics[2] + "_cos.txt")))
qca = FormatData(GetData(os.path.join(accDataDir, vectors[2] + "_atan.txt")))

fcs = FormatData(GetData(os.path.join(accDataDir, cordics[3] + "_sin.txt")))
